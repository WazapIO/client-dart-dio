...
import 'package:openapi/src/whatsapi/business_management_api.dart';
...
class Openapi {
  ...
  /// Get BusinessManagementApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  BusinessManagementApi getBusinessManagementApi() {
    return BusinessManagementApi(dio, serializers);
  }
  ...
  GroupManagementApi getGroupManagementApi() {
    return GroupManagementApi(dio, serializers);
  }
  ...
  /// Get MessageSendingApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  MessageSendingApi getMessageSendingApi() {
    return MessageSendingApi(dio, serializers);
  }
