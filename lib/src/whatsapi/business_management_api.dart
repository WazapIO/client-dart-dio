...
class BusinessManagementApi {
  ...
  /// Returns a [Future] containing a [Response] with a [APIResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<APIResponse>> sendPaymentRequest({ 
    required String instanceKey,
    required PaymentRequestPayload data,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/instances/{instance_key}/business/payment-request'.replaceAll('{' r'instance_key' '}', instanceKey.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PaymentRequestPayload);
