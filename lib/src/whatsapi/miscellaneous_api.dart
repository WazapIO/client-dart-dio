...
class MiscellaneousApi {
  ...
  const MiscellaneousApi(this._dio, this._serializers);
  ...
  Future<Response<APIResponse>> getProfilePic({ 
    ...
    final _path = r'/instances/{instance_key}/misc/profile-pic'.replaceAll('{' r'instance_key' '}', instanceKey.toString());
    ...
    final _queryParameters = <String, dynamic>{
      r'jid': encodeQueryParameter(_serializers, jid, const FullType(String)),
    };
  ...
  Future<Response<APIResponse>> getUsersInfo({ 
    ...
    final _path = r'/instances/{instance_key}/misc/user-info'.replaceAll('{' r'instance_key' '}', instanceKey.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
