...
class MiscellaneousApi {
  ...
  /// * [fileType] - File type
  /// * [data] - Media data
  /// * [responseType] - Response type (file, base64)
  ...
  Future<Response<APIResponse>> downloadMedia({ 
    required String instanceKey,
    required String fileType,
    required FileUpload data,
    String? responseType,
    ...
    final _path = r'/instances/{instance_key}/misc/download'.replaceAll('{' r'instance_key' '}', instanceKey.toString());
    ...
    final _queryParameters = <String, dynamic>{
      r'file_type': encodeQueryParameter(_serializers, fileType, const FullType(String)),
      if (responseType != null) r'response_type': encodeQueryParameter(_serializers, responseType, const FullType(String)),
    };

    dynamic _bodyData;

    try {
      const _type = FullType(FileUpload);
  ...
  /// Returns a [Future] containing a [Response] with a [APIResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<APIResponse>> setChatPresence({ 
    required String instanceKey,
    required String jid,
    ...
    final _path = r'/instances/{instance_key}/misc/chat-presence'.replaceAll('{' r'instance_key' '}', instanceKey.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'jid': encodeQueryParameter(_serializers, jid, const FullType(String)),
      r'presence': encodeQueryParameter(_serializers, presence, const FullType(String)),
    };
  ...
  /// Returns a [Future] containing a [Response] with a [APIResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<APIResponse>> updateProfilePic({ 
    required String instanceKey,
